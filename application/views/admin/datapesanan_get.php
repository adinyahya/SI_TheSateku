...
<body>
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        <div class="app-header header-shadow">
         ...
         <h1 class="modal-title">Data Pesanan Edit Pembayaran Sudah Lunas / Belum</h1>
        </div>
    ...
    <!-- <h6 style="color:red">Nama Penulis Pesanan </h6> -->
            ...
            <form method="post" action="<?php base_url('admin/products/lunasket') ?>" class="form" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="penerimaan" value="<?php echo $viewdata->penerimaan ?>" />

                    <div class="position-relative row form-group">
                    <div class="col-sm-10">
                    <p style="color:red">Silahkan ganti keterangan jika pembayaran lunas*</p>
